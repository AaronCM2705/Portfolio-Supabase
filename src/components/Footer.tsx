...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0f0f0f] border-t border-zinc-800 text-zinc-400 py-12 px-6 mt-20 relative overflow-hidden">
      ...
      {/* Linea roja decorativa arriba del todo */}
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
        ...
        {/* Lado derecho con las redes sociales */}
        <div className="flex flex-col items-center md:items-end gap-6">
          <div className="flex gap-4">
            {/* Ojo al target _blank para que abra en otra pestaña */}
      ...
      {/* Copyright y cosillas del final */}
      <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] md:text-xs uppercase font-mono tracking-widest text-center md:text-left">
        ...
        <div className="flex items-center gap-2 text-zinc-600">
          ...
          {/* El candado camuflado que lleva al panel de admin */}
